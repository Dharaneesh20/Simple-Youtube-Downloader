document.addEventListener('DOMContentLoaded', () => {
    ...
    function downloadCompleted(filename) {
        ...
        // Add download link for user to get their file
        if (filename && filename !== 'Download complete') {
            ...
            downloadLinkContainer.innerHTML = `
                <div class="download-ready">
                    ...
                    <p>Click the button below to download to your device:</p>
            ...
            const progressContainer = downloadProgress.querySelector('.progress-container');
            progressContainer.appendChild(downloadLinkContainer);
        }
        
        setTimeout(() => {
            // Don't hide immediately - let user download first
            showNotification(`Download ready: ${filename}`, 'success');
            ...
            // Add close button to hide progress after download
            const closeBtn = document.createElement('button');
            closeBtn.className = 'close-progress-btn';
